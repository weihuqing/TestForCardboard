    ...
    CardboardView.StereoRenderer
{
    ...
    private final float[] mLightPosInWorldSpace = new float[] {0.0f, 2.0f,
        0.0f, 1.0f};
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // 设置渲染器，CardboardView.StereoRenderer
    ...
    /**
     * [一句话功能简述]当线程即将关闭时唤起渲染器线程<BR>
     * [功能详细描述]
     * @see com.google.vrtoolkit.cardboard.CardboardView.StereoRenderer#onRendererShutdown()
     */
    @Override
    ...
    /**
     * [一句话功能简述]surface尺寸变化时调用<BR>
     * [功能详细描述]
     * @param width 新的surface宽度（px）
     * @param height 新的surface高度（px）
     * @see com.google.vrtoolkit.cardboard.CardboardView.StereoRenderer#onSurfaceChanged(int, int)
     */
    @Override
    ...
    public void onSurfaceCreated(EGLConfig config)
    {
        ...
        ByteBuffer bbVertices =
            ByteBuffer.allocateDirect(DATA.CUBE_COORDS.length * 4);
        ...
        ByteBuffer bbColors =
            ByteBuffer.allocateDirect(DATA.CUBE_COLORS.length * 4);
        ...
        ByteBuffer bbFoundColors =
            ByteBuffer.allocateDirect(DATA.CUBE_FOUND_COLORS.length * 4);
        ...
        ByteBuffer bbNormals =
            ByteBuffer.allocateDirect(DATA.CUBE_NORMALS.length * 4);
        ...
        int vertexShader =
            loadGLShader(GLES20.GL_VERTEX_SHADER, R.raw.light_vertex);
        int gridShader =
            loadGLShader(GLES20.GL_FRAGMENT_SHADER, R.raw.grid_fragment);
    ...
    public void onNewFrame(HeadTransform headTransform)
    {
        ...
        mModelViewProjectionParam =
            GLES20.glGetUniformLocation(mGlProgram, "u_MVP");
    ...
    public void onDrawEye(EyeTransform transform)
    {
        ...
        Matrix.multiplyMV(mLightPosInEyeSpace,
            0,
            mView,
            0,
            mLightPosInWorldSpace,
            0);
        GLES20.glUniform3f(mLightPosParam,
     ...
     * the shader.
     * 
     * 绘制立方体。我们已经建立了我们所有的变换矩阵。现在我们简单地将它们传递到着色器。
     */
    public void drawCube()
    {
        ...
        GLES20.glVertexAttribPointer(mPositionParam,
            COORDS_PER_VERTEX,
            GLES20.GL_FLOAT,
            false,
            0,
        ...
        GLES20.glUniformMatrix4fv(mModelViewProjectionParam,
            1,
            false,
        ...
        GLES20.glVertexAttribPointer(mNormalParam,
            3,
            GLES20.GL_FLOAT,
            false,
            0,
        ...
        {
            GLES20.glVertexAttribPointer(mColorParam,
                4,
                GLES20.GL_FLOAT,
                false,
                0,
    ...
    private boolean isLookingAtObject()
    {
        ...
        Log.i(TAG, "Object position: X: " + objPositionVec[0] + "  Y: "
            + objPositionVec[1] + " Z: " + objPositionVec[2]);
